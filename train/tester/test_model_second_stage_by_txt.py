...
if __name__ == "__main__":
    ...
    # testing parameters
    parser.add_argument("--videopath", type=str, default="F:\\dataset, my paper related\\VCGAN dataset\\test\\input\\videvo-gray", help="testing video folder path")
    parser.add_argument("--savepath", type=str, default="F:\\submitted papers\\my papers\\VCGAN v3\\VCGAN results\\l110_per0_gan1_short3_long5_lr5e-5\\videvo", help="saving folder path")
    ...
    parser.add_argument("--load_name", type=str, default="./models_for_ablation_study/setting3/models_l110_per0_gan1_short3_long5_lr5e-5/Second_Stage_epoch500_bs1_448p.pth", help="load the trained pth model with certain epoch")  # default = './models_l110_per5_gan1_short3_long5_lr5e-5/Second_Stage_epoch100_bs1_448p.pth', \
