...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--savepath",
        type=str,
        default="F:\\submitted papers\\my papers\\VCGAN v3\\VCGAN results\\ILSVRC2012_val_256_l110_per5_gan1_short3_long5_lr5e-5",
        help="saving folder path",
    )
    parser.add_argument(
        "--load_name",
        type=str,  # default = './trained_models/First_Stage_final.pth', \
