...
if __name__ == "__main__":
    ...
    parser.add_argument("--refpath", type=str, default="F:\\dataset, my paper related\\VCGAN dataset\\test\\input\\videvo", help="define reference path")
    parser.add_argument("--basepath", type=str, default="F:\\submitted papers\\my papers\\VCGAN v1\\VCGAN comparison\\CVPR19 (FAVC) (provided by author)\\videvo", help="define imgpath")
