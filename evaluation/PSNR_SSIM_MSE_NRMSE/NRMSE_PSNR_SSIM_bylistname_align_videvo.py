...
if __name__ == "__main__":
    ...
    parser.add_argument("--refpath", type=str, default="F:\\dataset, my paper related\\VCGAN dataset\\test\\input", help="define reference path")
    parser.add_argument("--basepath", type=str, default="F:\\submitted papers\\my papers\\VCGAN v3\\VCGAN results\\l110_per5_gan1_short3_long5_lr5e-5", help="define imgpath")
