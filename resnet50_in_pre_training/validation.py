...
if __name__ == "__main__":
    ...
    # Basic setting
    parser.add_argument("--finetune_path", type=str, default="./models/resnet50_in_rgb_epoch150_bs512.pth", help="pre-trained model name")
    ...
    # Dataset setting
    parser.add_argument("--baseroot", type=str, default="E:\\dataset\\ILSVRC2012_processed\\ILSVRC2012_val_256", help='the training folder, while adding "\\" at the end of this string')
