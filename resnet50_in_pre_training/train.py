...
if __name__ == "__main__":
    ...
    # Dataset setting
    parser.add_argument("--baseroot", type=str, default="C:\\Users\\ZHAO Yuzhi\\Desktop\\dataset\\ILSVRC2012_train_256\\", help='the training folder, while adding "\\" at the end of this string')
    ...
    # Network setting
    parser.add_argument("--type", type=str, default="resnet50", help="resnet type")
